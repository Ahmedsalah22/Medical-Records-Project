...
if($count>0){
    ...
    $sql = $con->prepare("SELECT * FROM medical_record WHERE record_id != $id");
    $sql->execute();
    $rows = $sql->fetchAll();
    ...
    foreach($rows as $pat)
    {
        ...
        if($hashedPass == $pat["Password"])
        {
		  ...
		  <div class="alert alert-info role="alert">
			   كلمة المرور هذه مستخدمه من قبل من فضلك أعد المحاولة مرة أخري.
 ...
 <form class="login" action="reset-conn1.php" method="post">
  ...
  <div class="text-center" style="margin-top:10px;font-weight:bold">
	...
	$sql = "UPDATE medical_record SET Password='$hashedPass'  WHERE record_id=$id";
...
if($count>0){
    ...
    $sql = $con->prepare("SELECT * FROM doctor WHERE doctor_id != $id");
    $sql->execute();
    $rows = $sql->fetchAll();
 ...
 <form class="login" action="reset-conn1.php" method="post">
  ...
  <div class="text-center" style="margin-top:10px;font-weight:bold">
	...
	$sql = "UPDATE doctor SET password='$hashedPass'  WHERE doctor_id=$id";
...
if($count>0){
    ...
    $sql = $con->prepare("SELECT * FROM receptionist WHERE receptionist_id != $id");
    $sql->execute();
    $rows = $sql->fetchAll();
 ...
 <form class="login" action="reset-conn1.php" method="post">
  ...
  <div class="text-center" style="margin-top:10px;font-weight:bold">
	...
	$sql = "UPDATE receptionist SET Password='$hashedPass'  WHERE receptionist_id=$id";
...
if($count>0){
    ...
    $sql = $con->prepare("SELECT * FROM lab_artist WHERE artist_id != $id");
    $sql->execute();
    $rows = $sql->fetchAll();
 ...
 <form class="login" action="reset-conn1.php" method="post">
  ...
  <div class="text-center" style="margin-top:10px;font-weight:bold">
	...
	$sql = "UPDATE lab_artist SET Password='$hashedPass'  WHERE artist_id=$id";
...
if($count>0){
    ...
    $sql = $con->prepare("SELECT * FROM health_ministry WHERE ministry_id != $id");
    $sql->execute();
    $rows = $sql->fetchAll();
 ...
 <form class="login" action="reset-conn1.php" method="post">
  ...
  <div class="text-center" style="margin-top:10px;font-weight:bold">
	...
	$sql = "UPDATE health_ministry SET Password='$hashedPass'  WHERE ministry_id=$id";
